...
MIDDLEWARE = [
    ...
    'Proj.apps.main.middlewares.AuthenticationMiddleware',
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': (
        'Proj.apps.main.permissions.IsAuthenticated',
    ),
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://127.0.0.1:6379/',  # Use the correct host and port for your Redis server
        'OPTIONS': {
